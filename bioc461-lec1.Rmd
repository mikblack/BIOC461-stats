...
## Getting some data
 ...
 - I've put some small example data sets on Blackboard (in the `Mik Black 2021` folder within `BIOC461`).
 - Download the zip file, unzip it, and move the contents to where you would like to save your work.
