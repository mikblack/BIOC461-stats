...
## Visualising the "meta-experiment"
 ...
 - Go to the website below, click on "Units" and select
 "Central Limit Theorem" under "Distributions":
 
    http://students.brown.edu/seeing-theory/index.html
 
 - Set the parameters to $\alpha=5$ and $\beta=5$, with a sample size of 10 (technically noyt a normal distribution, but close enough for our purposes).
...
<center><img src="PNG/confint.png" height="470"></center>
