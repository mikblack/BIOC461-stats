...
<center>
<img src="PNG/paired.png" height="300">
</center>
...
## Example (continued)
 - Do a one-sample t-test using the difference column only:
    - $\bar{y}_{diff}$ = 35 – 36 = –1.0
    - $S_{diff}$ = 1.414
    - $SE_{diff}$ = $S_{diff}/\sqrt{n}$ = 1.414$/\sqrt{\sf 6}$ = 0.577
    - t$_s$ = –1.0/0.577 = –1.732
    - –2.571 < t$_s$ < 2.571, so do not reject H$_0$.
 - This study does not provide evidence at the 0.05 significance level that flies 
