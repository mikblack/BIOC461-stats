...
## Example (continued)
 ...
 - Will reject H$_0$ if p < $\alpha =$ 0.05, otherwise will not reject H$_0$.
...
## Example (continued)
 - What values would we expect under H$_0$?
    ...
    - 26 patients took the drug: under H$_0$ expect 40.4% of them to improve = (26 $\times$ 0.404) = 10.5 = (26 $\times$ 19)/47. Similarly, expect number who improve under placebo to be  (21 $\times$ 19)/47 = 8.5.
...
## Example - questions
 - Are patients who take the drug more likely to improve than those who take the placebo?
    ...
    - H$_0$:  $\pi_1 = \pi_2$; the probability of improving is the same whether drug or placebo is taken (treatment and outcome are independent)
...
## How/Why does this work? 
 ...
 - For F-test, 
    ...
    - if the between-group variation is large compared to the amount of variability expected by chance, F is large; so reject H$_0$  

## Why not just do t-tests on each pair?  
 - You could, but the probability of making at least one Type I error is bigger than just the $\alpha$ you use for each test because there can be many possible pairs to test.
...
## Post-hoc testing
 - You can perform additional tests to determine which means are different:
